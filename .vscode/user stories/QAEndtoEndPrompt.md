...
## Workflow Overview
This prompt guides you through a complete 7-step QA workflow using MCP servers and Al agents to go from user
story to committed automated test scripts.


## STEP 1: Read User Story
Prompt:
I need to start
a new testing workflow. Please read the user story from
the file:
user-stories/QA-10-ecommerce-checkout.md
...
Prompt:
Based on the user story QA-10-ecommerce-checkout that we just reviewed, use the playwright-test-planner
agent to:
...
Prompt:
Now I need to create automated test scripts using the playwright-test-generator
agent.
- Please review:
1. Test plan from:
...
Prompt:
Now I need to execute the generated automation scripts and
heal any failures
using the
...
5. Repeat the heal process until all tests are
stable and
passing
6. Document:
...
| Git Repository URL: https://github.com/bimalsharma07/Agentic-QA-workflow
...
"feat (tests): Add complete test suite for ecommerce checkout workflow
